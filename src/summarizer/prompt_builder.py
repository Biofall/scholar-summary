...
def build_prompt(articles):
    ...
    instructions = (
        ...
        " in the summary as (Article X), where X corresponds to the article's number in the provided list. You do not need to use author "
        "names or any other information when referencing the articles other than the parenthetical citation.\n\n"
        ...
        "5. **Citations:** At the end of the report, generate a list of citations for all the articles you used in the report. The format should "
        "be a numbered list of citations, with the number on the list corresponding to the X of Article X. The, each list item should have "
        "First Author et. al and a link to the article.\n\n"
